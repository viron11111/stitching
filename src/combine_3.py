...
def image_callback(imageL, imageC, imageR):
  global calibration_status, left_features, center_features, right_features, matches, features,\
      ...
      cropped_final_imgs, seam_masks, images, low_imgs, final_imgs, low_sizes, camera_aspect
  ...
  #https://github.com/OpenStitching/stitching/discussions?discussions_q=is%3Aopen+video

  #https://github.com/OpenStitching/stitching/discussions/148

  camera_images = [imageLeft, imageCenter, imageRight]

  images = Images.of(camera_images)

  if calibration_status == 0:
    imgs = images.Resolution.FINAL
  ...
  compensator.feed(final_corners, warped_final_imgs, warped_final_masks)
...
def warp_images(cameras, imageLeft, imageCenter, imageRight):
  global warped_final_imgs, final_corners, final_sizes, warped_low_imgs, warped_low_masks,\
   low_corners, low_sizes, warped_final_masks, images, low_imgs, final_imgs, low_sizes, camera_aspect
...
def keypoint_generator(imgL, imgC, imgR):
  ...
  finder = FeatureDetector(nfeatures=100000)
