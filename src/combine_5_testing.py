...
class ImageStitcher_acg(Module):
  ...
  def stitch_pair(
    ...
    if calibration_status == 0:
      ...
      #print(homo[counter])
    homo[0] = torch.tensor([[[ 0.9999664,  -0.00805424,  0.00153651],[ 0.00812836,  0.99836266, -0.05662337],[-0.00107794,  0.05663396,  0.99839455]]], device='cuda:0')
    homo[1] = torch.tensor([[[ 0.98587394, 0.01577335,  0.16674496],[-0.00416016,  0.99755484, -0.06976769],[-0.16743767,  0.06808847,  0.98352873]]], device='cuda:0')
