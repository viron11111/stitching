...
def image_callback(imageL, imageC, imageR):
  ...
  matplotlib.image.imsave('cropped_final_masks0.png', cropped_final_masks[0])
  matplotlib.image.imsave('cropped_final_masks1.png', cropped_final_masks[1])
  matplotlib.image.imsave('cropped_final_masks2.png', cropped_final_masks[2])
  matplotlib.image.imsave('cropped_final_images0.png', cropped_final_imgs[0])
  matplotlib.image.imsave('cropped_final_images1.png', cropped_final_imgs[1])
  matplotlib.image.imsave('cropped_final_images2.png', cropped_final_imgs[2])
  matplotlib.image.imsave('seam_masks0.png', seam_masks[0].get())
  matplotlib.image.imsave('seam_masks1.png', seam_masks[1].get())
  matplotlib.image.imsave('seam_masks2.png', seam_masks[2].get())

  #print(cropped_final_masks)
